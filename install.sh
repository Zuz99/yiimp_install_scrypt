...
################################################################################
    ...
    sudo apt-get -y purge php8.* php8.*-*
    ...
    php8.2-recode php8.2-sqlite3 php8.2-tidy php8.2-xmlrpc php8.2-xsl memcached php8.2-memcache php8.2-memcached php-imagick php-gettext php8.2-zip php8.2-gd php8.2-mbstring \
